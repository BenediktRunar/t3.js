...
function W(){if((b[0]==b[4]&&b[4]==b[8])||(b[2]==b[4]&&b[4]==b[6]))return true;
if((b[0]==b[1]&&b[1]==b[2])||(b[3]==b[4]&&b[4]==b[5])||(b[6]==b[7]&&b[7]==b[8]))
return true;
if((b[0]==b[3]&&b[3]==b[6])||(b[1]==b[4]&&b[4]==b[7])||(b[2]==b[5]&&b[5]==b[8]))
return true;}i.on('data',function(k){if(k=='q')p.exit();if(k>0&&k<=9)t(k);d();
if(W()){o.write(N+' WINS\n');p.exit();}
if(C>8){o.write("It's a draw!\n");p.exit();}});d();
